...
## Write Skeletons to .obj
joints = m.J_transformed.r # (24,3)
outmesh_path = './hello_smpl_joints.obj'
with open(outmesh_path,'w') as fp:
    for jointIdx in range(joints.shape[0]):
        eachJoint = joints[jointIdx,:]
        fp.write( 'v %f %f %f\n' % ( eachJoint[0], eachJoint[1], eachJoint[2]) )

## Print message
print '..Output SMPL joints saved to: ', outmesh_path
